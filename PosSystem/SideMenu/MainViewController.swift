...
class MainViewController: LGSideMenuController {
    ...
    func setup(type: UInt) {
        ...
        let main = UIStoryboard(name: "Main", bundle: nil)
              ...
              let objHome = main.instantiateViewController(withIdentifier: "LeftViewController") as! LeftViewController
             leftViewController = objHome
               leftViewWidth = 320.0
    ...
    override func rightViewWillLayoutSubviews(with size: CGSize) {
        ...
        if (!isRightViewStatusBarHidden ||
            ...
            rightView?.frame = CGRect(x: 0.0, y: 0.0, width: size.width, height: size.height - 20.0)
        }
    }
